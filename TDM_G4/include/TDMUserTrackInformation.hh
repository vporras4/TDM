...
#ifndef TDMUserTrackInformation_h
#define TDMUserTrackInformation_h 1

enum TDMTrackStatus { active=1, hitPMT=2, absorbed=4, boundaryAbsorbed=8,
...
class TDMUserTrackInformation : public G4VUserTrackInformation
{
  public:

    TDMUserTrackInformation();
    virtual ~TDMUserTrackInformation();
