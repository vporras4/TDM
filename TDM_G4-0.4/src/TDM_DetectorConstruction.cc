...
//G4VPhysicalVolume* physical_Colimator4 =
 ...
 //G4VPhysicalVolume* physical_WaterCylinder =
 		new G4PVPlacement(0,
 				G4ThreeVector(-0.5495*m,0.265*m, -0.7585*m ),					//centrado en 0,0,0
...
/*****************Tapadera Blindaje *********************/
 		...
 		G4Tubs* Tapadera
 		 ...
 		 //G4VPhysicalVolume* physical_WaterCylinder =
 		 		new G4PVPlacement(0,
 		 				G4ThreeVector(-0.5495*m,0.265*m, 0.7585*m-Altura_cilindro-Altura_tapadera),					//centrado en 0,0,0
 		 				logic_tapadera,
...
/*
 ...
 /*************************************Detectors Primitive Score ****************************/
 		 		...
 		 		/****************Detector 0 ************************************/
 		 		TDM_TLD_Cons( vacuum, logic_WorldCube, "0Abso", G4ThreeVector(-0.5495*m,0.265*m,-0.209*m + camilla_Z)); //UN METRO DEL CENTRO DEL PMMA
